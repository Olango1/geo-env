...
dset = xr.open_dataset('C:/Users/Em/Desktop/phd/Geo-modelling/Data/Climate_Model_Data/tas_Amon_GFDL-ESM4_historical_r1i1p1f1_gr1_195001-201412.nc', decode_times=True)
dset_1900 = xr.open_dataset('C:/Users/Em/Desktop/phd/Geo-modelling/Data/Climate_Model_Data/tas_Amon_GFDL-ESM4_historical_r1i1p1f1_gr1_185001-194912.nc')
dset_2100_s1 = xr.open_dataset('C:/Users/Em/Desktop/phd/Geo-modelling/Data/Climate_Model_Data/tas_Amon_GFDL-ESM4_ssp119_r1i1p1f1_gr1_201501-210012.nc')
dset_2100_s2 = xr.open_dataset('C:/Users/Em/Desktop/phd/Geo-modelling/Data/Climate_Model_Data/tas_Amon_GFDL-ESM4_ssp245_r1i1p1f1_gr1_201501-210012.nc')
dset_2100_s3 = xr.open_dataset('C:/Users/Em/Desktop/phd/Geo-modelling/Data/Climate_Model_Data/tas_Amon_GFDL-ESM4_ssp585_r1i1p1f1_gr1_201501-210012.nc')
dset
...
plt.savefig('C:/Users/Em/Desktop/phd/Geo-modelling/Results/Mean Air Temperature Map(1850-1900).png', dpi=300)
plt.show()
...
# Show the save and plot
plt.savefig('C:/Users/Em/Desktop/phd/Geo-modelling/Results/Mean Air Temperature Map(2071-2100)', dpi=300)
plt.show()

###########################################
# Plotting temperature difference maps
fig, axes = plt.subplots(3, 1, figsize=(15, 10), subplot_kw={'projection': ccrs.PlateCarree()})
axes = axes.flatten()
...
# Show the save and plot
plt.savefig('C:/Users/Em/Desktop/phd/Geo-modelling/Results/Temperature difference', dpi=300)
plt.show()